package com.xdj.www.core.tools;
...
public class ExcelUnit{
  ...
  public static void exportTable2Excel(String title, String[] headers, Collection dataset, OutputStream out, String pattern)
  {
    ...
    style_.setFillPattern(FillPatternType.forInt((short)1));
    style_.setBorderBottom(BorderStyle.valueOf((short)1));
    style_.setBorderLeft(BorderStyle.valueOf((short)1));
    style_.setBorderRight(BorderStyle.valueOf((short)1));
    style_.setBorderTop(BorderStyle.valueOf((short) 1));

    style_.setAlignment(HorizontalAlignment.forInt(2));
    style_.setVerticalAlignment(VerticalAlignment.forInt((short)1));
