...
public class ShoppingRefundLog extends BaseEntity{
    private Long id;
    ...
    private ShoppingUser refund_user;

    public ShoppingUser getRefund_user() {
        return refund_user;
    }

    public void setRefund_user(ShoppingUser refund_user) {
