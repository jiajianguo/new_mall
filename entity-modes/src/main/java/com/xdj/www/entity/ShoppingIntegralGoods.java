...
public class ShoppingIntegralGoods extends BaseEntity{
    private Long id;
    ...
    private ShoppingAccessory igGoodsImg;

    public ShoppingAccessory getIgGoodsImg() {
        return igGoodsImg;
    }

    public void setIgGoodsImg(ShoppingAccessory igGoodsImg) {
