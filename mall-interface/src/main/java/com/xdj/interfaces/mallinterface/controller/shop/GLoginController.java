...
import com.xdj.interfaces.mallinterface.util.HttpClientUtil;
...
public class GLoginController {
   ...
   private static String client_id = "347747160606-kv21bom4n6n0iddn3nb6k1inuuj9pjck.apps.googleusercontent.com";
    private static String client_secret ="yKNKfEY1HfhzVIZ-VRw8njOT";
    private static String scope = "https://www.googleapis.com/auth/drive.metadata.readonly";
    private static String redirect_url = "http://emode.xdjplus.com";
...
//		System.out.println(verifyToken);
     ...
     * @Title: sendRedirect
     * @Description:发送授权请求
     * @author 第二步，在google.jsp中用户登录成功以后回跳转到这个路径，发送请求让用户授权，授权成功后重定向到创建应用时定义的重定向地址
     * @return String
...
//		return idToken;
    ...
    public static JSONObject verifyToken(String idToken){
        ...
        if (null != responseResult) {
            String result = "";
            verifyInfo =  JSONObject.parseObject(result);
        }
        return verifyInfo;
    }
}
