...
public class QrCodeUtils {
     ...
     * @throws Exception
     */
    public static String encode(String content, String logoPath, String destPath, boolean needCompress,String fileName) throws Exception {
     ...
     * @param logoPath LOGO地址
     * @param destPath 存储地址
     * @param  fileName 保存二维码文件名字
     * @throws Exception
     */
    public static String encode(String content, String logoPath, String destPath,String fileName) throws Exception {
        return QrCodeUtils.encode(content, logoPath, destPath, false,fileName);
    }
    ...
    public static String encode(String content, String destPath, boolean needCompress) throws Exception {
        return QrCodeUtils.encode(content, null, destPath, needCompress,null);
    }
    ...
    public static String encode(String content, String destPath,String fileName) throws Exception {
        return QrCodeUtils.encode(content, null, destPath, false,fileName);
    }
