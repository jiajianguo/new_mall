 package com.xdj.interfaces.mallinterface.pay.alipay.config;

 public class AlipayConfig{
   private String partner = "2088731903223493";

   private String key = "fq2q0xxzu4xe3k3mgaewd3u7hq0quvmy";

   private String seller_email = "cqcuijingyuan@163.com";

   private String notify_url = "http://emode.xdjplus.com/alipay_notify.htm";

   private String return_url = "http://emode.xdjplus.com/aplipay_return.htm";
